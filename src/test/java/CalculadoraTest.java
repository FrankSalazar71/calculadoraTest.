...
public class CalculadoraTest {
    ...
    void testRestarPositivos() {
        System.out.println("Probando restar con positivos: 10 - 4");
        int esperado = 6;
        int obtenido = calc.restar(10, 4);
    ...
    void testRestarNegativos() {
        System.out.println("Probando restar con negativos: -5 - (-3)");
        int esperado = -2;
        int obtenido = calc.restar(-5, -3);
        System.out.println("Esperado: " + esperado + ", Obtenido: " + obtenido);
        assertEquals(esperado, obtenido);
    }
    ...
    void testMultiplicarPorCero() {
        System.out.println("Probando multiplicar por cero: 7 * 0");
        int esperado = 0;
        int obtenido = calc.multiplicar(7, 0);
        System.out.println("Esperado: " + esperado + ", Obtenido: " + obtenido);
        assertEquals(esperado, obtenido);
    }
    ...
    void testMultiplicarNegativos() {
        System.out.println("Probando multiplicar negativos: -3 * 4");
        int esperado = -12;
        int obtenido = calc.multiplicar(-3, 4);
        System.out.println("Esperado: " + esperado + ", Obtenido: " + obtenido);
        assertEquals(esperado, obtenido);
    }

    // Pruebas para porcentaje
    @Test
    ...
    // Pruebas para raizCuadrada
    @Test
    void testRaizCuadradaNormal() {
        System.out.println("Probando raizCuadrada con 16");
        double esperado = 4.0;
    ...
    void testRaizCuadradaNegativo() {
        System.out.println("Probando raizCuadrada con -9 (debe lanzar excepción)");
